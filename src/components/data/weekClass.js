...
var day1 = new Day('01', 'monday', 'rest', 'rest up', '', false)
var day2 = new Day(
  '02',
  'tuesday',
  'interval',
...
var day3 = new Day('03', 'wednesday', 'run', '4 - 7k @moderate', '', false)
var day4 = new Day(
  '04',
  'thursday',
  'fartlek',
...
var day5 = new Day('05', 'friday', 'rest', 'rest up', '', false)
var day6 = new Day(
  '06',
  'saturday',
  'tempo',
...
var day7 = new Day('07', 'sunday', 'run', '7k @easy', '', false)
// end week one
// start week two
var day8 = new Day('08', 'monday', 'rest', 'rest up', '', false)
var day9 = new Day(
  '09',
  'tuesday',
  'interval',
...
var day10 = new Day('10', 'wednesday', 'run', '4 - 7k @moderate', '', false)
var day11 = new Day(
  '11',
  'thursday',
  'run',
...
var day12 = new Day('12', 'friday', 'rest', 'rest up', '', false)
var day13 = new Day(
  '13',
  'saturday',
  'tempo',
...
var day14 = new Day('14', 'sunday', 'run', '8k @easy', '', false)
//end week two
// start week three
var day15 = new Day('15', 'monday', 'rest', 'rest up', '', false)
var day16 = new Day(
  '16',
  'tuesday',
  'interval',
...
var day17 = new Day('17', 'wednesday', 'run', '6 - 8k @moderate', '', false)
var day18 = new Day(
  '18',
  'thursday',
  'fartlek',
...
var day19 = new Day('19', 'friday', 'rest', 'rest up', '', false)
var day20 = new Day(
  '20',
  'saturday',
  'tempo',
...
var day21 = new Day('21', 'sunday', 'run', '7k @easy', '', false)
//end week three
// start week four
var day22 = new Day('22', 'monday', 'rest', 'rest up', '', false)
var day23 = new Day(
  '23',
  'tuesday',
  'interval',
...
var day24 = new Day('24', 'wednesday', 'run', '7 - 10k @moderate', '', false)
var day25 = new Day(
  '25',
  'thursday',
  'tempo',
...
var day26 = new Day('26', 'friday', 'rest', 'rest up', '', false)
var day27 = new Day(
  '27',
  'saturday',
  'tempo',
...
var day28 = new Day('28', 'sunday', 'run', '10k @easy', '', false)
//end week four
// start week five
var day29 = new Day('29', 'monday', 'rest', 'rest up', '', false)
var day30 = new Day(
  '30',
  'tuesday',
  'interval',
...
var day31 = new Day('31', 'wednesday', 'run', '6 - 8k @easy', '', false)
var day32 = new Day(
  '32',
  'thursday',
  'run',
...
var day33 = new Day('33', 'friday', 'rest', 'rest up', '', false)
var day34 = new Day(
  '34',
  'saturday',
  'pyramid',
...
var day35 = new Day('35', 'sunday', 'run', '12k @easy', '', false)
//end week five
// start week six
var day36 = new Day('36', 'monday', 'rest', 'rest up', '', false)
var day37 = new Day(
  '37',
  'tuesday',
  'interval',
...
var day38 = new Day('38', 'wednesday', 'run', '7 - 10k @easy', '', false)
var day39 = new Day(
  '39',
  'thursday',
  'fartlek',
...
var day40 = new Day('40', 'friday', 'rest', 'rest up', '', false)
var day41 = new Day(
  '41',
  'saturday',
  'tempo',
...
var day42 = new Day('42', 'sunday', 'run', '12k @easy', '', false)
//end week six
// start week seven
var day43 = new Day('43', 'monday', 'rest', 'rest up', '', false)
var day44 = new Day(
  '44',
  'tuesday',
  'interval',
...
var day45 = new Day('45', 'wednesday', 'run', '6 - 8k @easy', '', false)
var day46 = new Day(
  '46',
  'thursday',
  'tempo',
...
var day47 = new Day('47', 'friday', 'rest', 'rest up', '', false)
var day48 = new Day(
  '48',
  'saturday',
  'tempo',
...
var day49 = new Day('49', 'sunday', 'run', '12k @easy', '', false)
//end week seven
// start week eight
var day50 = new Day('50', 'monday', 'rest', 'rest up', '', false)
var day51 = new Day(
  '51',
  'tuesday',
  'interval',
...
var day52 = new Day('52', 'wednesday', 'run', '6 - 8k @easy', '', false)
var day53 = new Day('53', 'thursday', 'run', '30 - 40 min @easy', '', false)
var day54 = new Day('54', 'friday', 'rest', 'rest up', '', false)
var day55 = new Day(
  '55',
  'saturday',
  'tempo',
...
var day56 = new Day('56', 'sunday', 'race', '10k @veryhard', '', false)
//end week eight
